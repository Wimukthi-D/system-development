...
INSERT INTO DRUG(DID,DNAME,QUANTITY,PRICE,MFD,EXP_DATE,GID)
 VALUES
'PANADOL (500mg)',1000,4,'2023-01-01','2026-01-01','GA001'),
'PARAGON (500mg)',1000,4,'2023-01-01','2026-01-01','GA001'),
'PACIDOL (500mg)',1000,4,'2023-01-01','2026-01-01','GA001'),
'VIT-C (100mg)',1000,2.50,'2023-01-01','2026-01-01','GA002'),
'XON-CE (500mg)',1000,28,'2023-01-01','2026-01-01','GA002'),
'CEE (500mg)',1000,28,'2023-01-01','2026-01-01','GA002'),
'PIRITON (4mg)',1000,2,'2023-01-01','2026-01-01','GA003'),
'ALLERMINE (4mg)',1000,3,'2023-01-01','2026-01-01','GA003'),
'ZIN (10mg)',1000,3,'2023-01-01','2026-01-01','GA004'),
'SET (10mg)',1000,3,'2023-01-01','2026-01-01','GA004'),
'ALERID (10mg)',1000,4,'2023-01-01','2026-01-01','GA004'),
'PREDNISELONE (1mg)',1000,2,'2023-01-01','2026-01-01','GA005'),
'DEXAMETHSONE (0.5mg)',1000,2,'2023-01-01','2026-01-01','GA006'),
'DERIPHYLLIN (150mg)',1000,2,'2023-01-01','2026-01-01','GA007'),
'DERIPHYLLIN (300mg)',1000,3,'2023-01-01','2026-01-01','GA007'),
'ATALIN (10mg)',1000,2.50,'2023-01-01','2026-01-01','GA008'),
'TURBUTE (10mg)',1000,3,'2023-01-01','2026-01-01','GA008'),
'AMYN (250mg)',1000,20,'2023-01-01','2026-01-01','GA009'),
'AMYN (500mg)',1000,28,'2023-01-01','2026-01-01','GA009'),
'AXCIL (250mg)',1000,22,'2023-01-01','2026-01-01','GA009'),
'AXCIL (500mg)',1000,30,'2023-01-01','2026-01-01','GA009'),
'RAPIDENE (500mg)',1000,25,'2023-01-01','2026-01-01','GA010'),
'PANADENE (500mg)',1000,26,'2023-01-01','2026-01-01','GA010'),
'OMEZ (20mg)',1000,12,'2023-01-01','2026-01-01','GA011'),
'LOKIT (20mg)',1000,10,'2023-01-01','2026-01-01','GA011'),
'SALBUTAMOL (2mg)',1000,2,'2023-01-01','2026-01-01','GA012'),
'SALBUTAMOL (4mg)',1000,3,'2023-01-01','2026-01-01','GA012'),
'AUGMENTIN (375mg)',1000,40,'2023-01-01','2026-01-01','GB001'),
'AUGMENTIN (625mg)',1000,50,'2023-01-01','2026-01-01','GB001'),
'CLARITEK (250mg)',1000,34,'2023-01-01','2026-01-01','GB002'),
'CLARITEK (500mg)',1000,42,'2023-01-01','2026-01-01','GB002'),
'CIPROBID (250mg)',1000,23,'2023-01-01','2026-01-01','GB003'),
'CIPROBID (500mg)',1000,30,'2023-01-01','2026-01-01','GB003'),
'AZEE (250mg)',1000,26,'2023-01-01','2026-01-01','GB004'),
'AZEE (500mg)',1000,34,'2023-01-01','2026-01-01','GB004'),
'AZ (250mg)',1000,26,'2023-01-01','2026-01-01','GB004'),
'AZ (500mg)',1000,34,'2023-01-01','2026-01-01','GB004'),
'ATOCOR (10mg)',1000,18,'2023-01-01','2026-01-01','GC001'),
'ATOCOR (20mg)',1000,27,'2023-01-01','2026-01-01','GC001'),
'ATOCOR (40mg)',1000,36,'2023-01-01','2026-01-01','GC001'),
'ATORVA (10mg)',1000,18,'2023-01-01','2026-01-01','GC001'),
'ATORVA (20mg)',1000,27,'2023-01-01','2026-01-01','GC001'),
'ATORVA (40mg)',1000,36,'2023-01-01','2026-01-01','GC001'),
'GLYCOMET (500mg)',1000,25,'2023-01-01','2026-01-01','GD001'),
'MELMET (500mg)',1000,25,'2023-01-01','2026-01-01','GD001'),
'SRIMET (500mg)',1000,25,'2023-01-01','2026-01-01','GD001'),
'GLUCOPHAGE (500mg)',1000,25,'2023-01-01','2026-01-01','GD001'),
'BIGMET (500mg)',1000,25,'2023-01-01','2026-01-01','GD001'),
'METFORMIN SPMC (500mg)',1000,15,'2023-01-01','2026-01-01','GD001'),
'GLYCOMET SR (500mg)',1000,25,'2023-01-01','2026-01-01','GD002'),
'MELMET SR (500mg)',1000,25,'2023-01-01','2026-01-01','GD002'),
'GLUCOPHAGE SR (500mg)',1000,27,'2023-01-01','2026-01-01','GD002'),
'DIBETA SR (500mg)',1000,28,'2023-01-01','2026-01-01','GD002'),
'NEVOX XR (500mg)',1000,32,'2023-01-01','2026-01-01','GD002'),
'METFORMIN SR SPMC (500mg)',1000,20,'2023-01-01','2026-01-01','GD002'),
'GLYCLAPAN (40mg)',1000,8,'2023-01-01','2026-01-01','GD003'),
'GLYCLAPAN (80mg)',1000,14,'2023-01-01','2026-01-01','GD003'),
'GLIX (40mg)',1000,12,'2023-01-01','2026-01-01','GD003'),
'GLIX (80mg)',1000,18,'2023-01-01','2026-01-01','GD003'),
...
GLUCOPHAGE (500mg)
BIGMET (500mg)
METFORMIN SPMC (500mg)
GLYCOMET SR (500mg)
MELMET SR (500mg)
GLUCOPHAGE SR (500mg)
DIBETA SR (500mg)
NEVOX XR (500mg)
METFORMIN SR SPMC (500mg)
GLYCLAPAN (40mg)
GLYCLAPAN (80mg)
GLIX (40mg)
GLIX (80mg)